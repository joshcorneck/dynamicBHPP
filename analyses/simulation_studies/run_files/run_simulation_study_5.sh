...
# for PBS_ARRAYID in {0}; do
#     echo "Running simulation for parameter set ${PBS_ARRAYID}"
#     python3 analyses/simulation_studies/simulation_parameters/simulation_study_5/simulation_study_5.py --index ${PBS_ARRAYID} 
# done
python3 analyses/simulation_studies/simulation_parameters/simulation_study_5/simulation_study_5.py 
