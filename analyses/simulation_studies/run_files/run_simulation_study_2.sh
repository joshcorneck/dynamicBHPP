...
mkdir ../simulation_output/rate_changes
...
for PBS_ARRAYID in {0..11}; do
    ...
    python3 analyses/simulation_studies/simulation_parameters/simulation_study_2/simulation_study_2.py --index ${PBS_ARRAYID} 
done
