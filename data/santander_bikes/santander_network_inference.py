...
with open('santander_network.pkl', 'rb') as file:
    santander_network = pickle.load(file)

# Read in the relevant data from the array
with open('santander_params.txt', 'r') as file:
...
with open(f'santander_output/tau_store_{pbs_index}.pkl','wb') as f:
    pickle.dump(tau_store, f)
f.close()

gamma_store = VB.gamma_store
with open(f'santander_output/n_store_{pbs_index}.pkl','wb') as f:
    pickle.dump(gamma_store, f)
f.close()

alpha_store = VB.alpha_store
with open(f'santander_output/alpha_store_{pbs_index}.pkl','wb') as f:
    pickle.dump(alpha_store, f)
f.close()

beta_store = VB.beta_store
with open(f'santander_output/beta_store_{pbs_index}.pkl','wb') as f:
