...
###
# STEP 3 - RUN THE INFERENCE (FIXED NUMBER OF GROUPS)
###
...
save_to_pickle(tau_store, f'{base_dir}/tau', f'tau_store_inf_groups.pkl')

group_memberships = VB.group_memberships
save_to_pickle(group_memberships, f'{base_dir}/group_memberships', f'group_memberships_inf_groups.pkl')

alpha_store = VB.alpha_store
save_to_pickle(alpha_store, f'{base_dir}/alpha', f'alpha_store_inf_groups.pkl')

beta_store = VB.beta_store
save_to_pickle(beta_store, f'{base_dir}/beta', f'beta_store_inf_groups.pkl')