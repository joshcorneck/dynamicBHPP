...
class VariationalBayes:
    ...
    def __init__(self, sampled_network: Dict[int, Dict[int, list]], 
                 num_nodes: int, num_groups: int, alpha_0: np.array, beta_0: np.array, 
                 gamma_0: np.array, adj_mat: np.array=None, infer_graph_bool: bool=False, 
                 sigma_0: np.array=None, eta_0: np.array=None, zeta_0: np.array=None, 
